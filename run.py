from network import *
from train import plot_results, train_model, plot_results_over_line, plot_results_for_cells
...
edge_weight = False
n_objects, batch_size, n_epoch = 100, 1, 1500
...
plot_results_for_cells(model, train_data)